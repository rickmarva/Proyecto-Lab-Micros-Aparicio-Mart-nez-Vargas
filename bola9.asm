...
section .data
        ...
        bola_1:db 0x1b,"[01;50H","@",0xa			;Aqui se asigna la posiciòn inicial de la bola
...
.bloque_a:
	...
	jmp .bloque_3		;regresa al bloque que pregunta izquierda-derecha
...
.bloque_5.5:		;compara si las unidades son igual a 1
	...
	je .bloque_3		;realiza desplazamientos a la derecha
...
.bloque_c:
        ...
        jmp .bloque_5		;vuelve al ciclo de izquierda
