...
.bloque_4.1: ;desplazamientos a la derecha abajo
	...
	mov rax,[bola_1 + 6]      ;mueve a rax  el byte de  memoria almacenado en palabra1_ + 6
        ...
        je .bloque_4.1.2         ;si es igual aumenta decenas, y pone en 0 unidades
        jne .bloque_4.1.1	 ;si no es igual simplemente incrementa unidades

.bloque_4.1.1:              ;desplazamientos a la derecha abajo unidades
...
.bloque_4.1.2:              ;desplazamientos a la derecha abajo incremento decenas
...
.bloque_4.2:   ;desplazamientos a la derecha arriba
	...
	mov rax,[bola_1 + 6]      ;mueve a rax  el byte de  memoria almacenado en palabra1_ + 6
        and rax,mascara          ;extiende el byte de rax a los 32 para ppoder compararlo con el 57 enb ascii
        cmp rax,57               ;compara si el registro es igual a 9
        je .bloque_4.2.2         ;si es igual decrementa  decenas, y pone en 9 unidades
        jne .bloque_4.2.1        ;si no es igual simplemente decrementa  unidades
