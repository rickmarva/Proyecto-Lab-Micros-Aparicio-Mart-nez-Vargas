...
section .data
        ...
        bola_1:db 0x1b,"[11;10H","@",0xa ;no poner cordenadas iguales para que la bola pueda rebotar a todo lado
...
.bloque_3:	;bloque izquierda-derecha
        ...
        cmp rax,56               ;compara si el registro es igual a 8, asi permite que la bola rebote por todo lado, si pongo un 57, rebota en forma de rombo-------------------------------------------------
