...
section .data
        ...
        bola_1:db 0x1b,"[01;30H","@",0xa			;Aqui se asigna la posiciòn inicial de la bola
	...
	subebaja: db "0",0xa					;bandera para indicarle al programa si sube o baja
	izqder: db "1",0xa
...
.bloque_der:	;bloque izquierda-derecha
        ...
        je .bloque_3              ;si es igual salta al bloque 5 que es de izquierda arriba-abajo
...
.bloque_a:
	...
	jmp .bloque_izqder		;regresa al bloque que pregunta izquierda-derecha
...
.bloque_izq:
	...
	mov rax,[bola_1 + 5]    ;mueve al registro las decenas del eje horizontal
        and rax,mascara         ;elimina bits basura
        cmp rax,48              ; compara con 0 
        je .bloque_5          ;compara si las unidades son igual a 1
        jne .bloque_6           ;realiza desplazamientos a la izquierda

.bloque_5:		;compara si las unidades son igual a 1

	mov rax,[bola_1 + 6]	;mueve al registro las unidades del eje horizontal
	and rax,mascara		;elimina bits basura
	cmp rax,49		;comparo si llego a la posicion 1
	je .bloque_5.5		;realiza desplazamientos a la derecha
	jne .bloque_6		;continua con desplazamientos a la izquierda

.bloque_5.5:            ;mantiene el desplazamiento a la izquierda hasta la posicion 01 horizontal

        mov rax,49
        mov [izqder+1],rax    ;mueve al registro las decenas del eje horizontal
	syscall
        jmp .bloque_izqder
...
.bloque_c:
        ...
        jmp .bloque_izqder	;vuelve al ciclo de izquierda
