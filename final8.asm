...
section .data
	...
	palabra_1:db 0x1b,"[29;22H","-------",0x1b,"[10;2H",0xa;barra del juego
	tampal_1: equ $-palabra_1

	borra: db 0x1b,"[29;02H","                                                ",0xa ;variable de limpieza de la pantalla al mover la barra
        tamb: equ $-borra
	...
	bola_1:db 0x1b,"[27;27H","@",0x1b,"[11;1H"			;Aqui se asigna la posiciòn inicial de la bola
	...
	mov byte[termios + CC +VTIME],1
        mov byte[termios + CC +VMIN],0
